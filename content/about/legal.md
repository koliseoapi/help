...
<div class="layman-terms">In which we make clear that in order to use this website these conditions must first be accepted.</div>

Individuals that make use of Koliseo (hereinafter Users) should read the present Terms and Conditions. The use or access to Koliseo implies the knowledge and full acceptance of the legal warnings and conditions detailed below. Extrema Sistemas reserves the right to modify these Terms of Use on their own initiative and without prior notice to the User, such requirements entering into force from the time of publication on the web and applied retroactively.

Extrema Sistemas reserves the right to change without prior notice the design, layout and configuration of Koliseo, as well as any existing or new services. Also, Extrema Sistemas reserves the right to, at any time and without notice, deny access to this site to those Users who violate any of these legal conditions or the particular ones that apply to them.
...
<div class="layman-terms">In which the age limit and permitted uses of Koliseo are specified.  It is not allowed to send spam, spread information against morality or reselling tickets. When in doubt, common sense tends to do well.</div>

### Register in the system

Koliseo does not store user credentials, and instead delegates in third-party authentication systems. The first time a user logs into Koliseo, the server creates a User Account. The login page clearly states that by logging into the system, the User expresses acceptance of these Terms and Conditions.

The minimum age requirement to use Koliseo is 14 years old. The minor children should always ask and get permission from their parents, guardian or legal representative before accessing Koliseo. It is prohibited the access and use to minors that are not authorized. Extrema Sistemas understands that when a minor accesses Koliseo he has the permission of parents, guardian or legal representative. As legal guardian of the children in their care, remember that Koliseo may incorporate information aiming at a diverse audience, and therefore there may be specific areas or sections that include content or comments inappropriate to the minors.

Extrema Sistemas cannot validate the accuracy of data entered and is not responsible for any Users distorting the data. Extrema Sistemas will proceed to block any Users that are found not to meet the minimum legal age or have misrepresented any other data.
...
In order to make the purchase of tickets, the User declares to be an adult (18 years old or more, depending on applicable law) with the legal capacity to purchase tickets through Koliseo, stating that they accept being bound by this Agreement and understands and accepts all the conditions set forth here for using Koliseo.
...
<div class="layman-terms">In which we clarify that we are going to make mistakes because this system is being developed by humans. However, we keep working hard to make errors memorable as a funny anecdote.</div>

The User acknowledges that it is not technically possible to achieve 100% uptime of Koliseo. Extrema Sistemas does not guarantee the availability and continuity of the service. Extrema Sistemas will not be liable for damages of any kind that may be due to lack of availability or fraudulent use that Users could have made of Koliseo. Extrema Sistemas does not assume any responsibility for any problems accessing the pages of Koliseo. However, Extrema Sistemas will strive to maintain the availability of Koliseo as continuously as possible.
...
<div class="layman-terms">In which the duration of these legal conditions is measured as well as the right of Extrema Sistemas to remove conflicting contents.</div>

The term of this Legal Agreement is indefinite. Extrema Sistemas may terminate or suspend the availability of any content if it is understood that violates these Terms and Conditions as well as suspend the account of the user responsible.
...
<div class="layman-terms">We remain reasonable and open to discussion, but in Madrid.</div>
